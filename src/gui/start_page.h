...
info StartPage() {
    ...
    RecodingWindow * r_temp = new RecodingWindow;
    ...
    r_temp = dynamic_cast<RecodingWindow *>(r_temp -> copy());
    ...
    RecodingWindow day(RLenght, RHeight, 0);
    ...
    RecodingWindow outlets(RLenght, RHeight, 0);
    ...
    RecodingWindow package(RLenght, RHeight, 0);
                ...
                if (event.mouseButton.button == sf::Mouse::Left) {
                    ...
                    if (start.In(x, y) && start.IsActive()) {
                        ...
                        if (package.getString() != L"") {
                            result.packege = s_to_i(package.getString());
                        } else {
                            TRY = false;
                            continue;
                        }
